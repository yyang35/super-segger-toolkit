...
class LinkReader:
    ...
    def abstract_trackmate_linking_result(self,spots_filename, edge_filename,  UNIT_CONVERT_COEFF = 1):
        spots = self.match_trackmate_cell_id_to_mask_label(spots_filename,  UNIT_CONVERT_COEFF =  UNIT_CONVERT_COEFF )
        G =  self.abstact_tackmate_single_frame_assignment_matrix(spots, edge_filename)
        return G
    

    def match_trackmate_cell_id_to_mask_label(self, spots_filename, UNIT_CONVERT_COEFF = 1):
    ...
    def abstact_tackmate_single_frame_assignment_matrix(self, spots_df, edge_filename):
        # Read top 4 line as header by trackmate dataformat

...
class LinkReader:
    ...
    def abstract_trackmate_linking_result(self,spots_filename, edge_filename):
        spots = self.match_trackmate_cell_id_to_mask_label(spots_filename)
        track_dict =  self.abstact_tackmate_single_frame_assignment_matrix(spots, edge_filename)
        return track_dict
